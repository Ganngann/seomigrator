"""
Django settings for seomigratorpy project.
...
ROOT_URLCONF = 'seomigratorpy.urls'
...
WSGI_APPLICATION = 'seomigratorpy.wsgi.application'
...
ASGI_APPLICATION = 'seomigratorpy.routing.application'
CHANNEL_LAYERS = {
    'default': {
